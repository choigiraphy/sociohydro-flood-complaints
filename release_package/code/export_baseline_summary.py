...
import pandas as pd
from wrr_figure_support import REPO_ROOT
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input-path", type=Path, default=REPO_ROOT / "tables" / "bootstrap_results.xlsx")
    parser.add_argument("--output-path", type=Path, default=REPO_ROOT / "tables" / "baseline_distribution_summary.xlsx")
