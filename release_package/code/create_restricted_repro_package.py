...
from wrr_figure_support import REPO_ROOT, resolve_first_existing

INPUT_PATH = resolve_first_existing(
    Path("/Volumes/Keywest_JetDrive/학교/2026-1/AGU_WRR_Choi/Code/wrr_reproducible/data/emotion_ensemble.xlsx"),
    Path("/Volumes/Keywest_JetDrive 1/학교/2026-1/AGU_WRR_Choi/Code/wrr_reproducible/data/emotion_ensemble.xlsx"),
)
...
README_PATH = REPO_ROOT / "restricted_reproducibility_package.md"
