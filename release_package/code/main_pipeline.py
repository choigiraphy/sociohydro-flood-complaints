...
from wrr_figure_support import resolve_first_existing
...
DEFAULT_EMOTION_PATH = resolve_first_existing(
    Path("/Volumes/Keywest_JetDrive/데이터저장소/final/emotion_ensemble_complete_results_results_english_2.xlsx"),
    Path("/Volumes/Keywest_JetDrive 1/데이터저장소/final/emotion_ensemble_complete_results_results_english_2.xlsx"),
)
DEFAULT_PRECIP_PATHS = [
    resolve_first_existing(
        Path("/Volumes/Keywest_JetDrive/학교/2025-2/논문/data/precip_asos_2021.csv"),
        Path("/Volumes/Keywest_JetDrive 1/학교/2025-2/논문/data/precip_asos_2021.csv"),
    ),
    resolve_first_existing(
        Path("/Volumes/Keywest_JetDrive/학교/2025-2/논문/data/precip_asos_2022.csv"),
        Path("/Volumes/Keywest_JetDrive 1/학교/2025-2/논문/data/precip_asos_2022.csv"),
    ),
    resolve_first_existing(
        Path("/Volumes/Keywest_JetDrive/학교/2025-2/논문/data/precip_asos_2023.csv"),
        Path("/Volumes/Keywest_JetDrive 1/학교/2025-2/논문/data/precip_asos_2023.csv"),
    ),
]
DEFAULT_BOUNDARY_PATH = resolve_first_existing(
    Path("/Volumes/Keywest_JetDrive/데이터저장소/skorea-municipalities-2018-geo.json"),
    Path("/Volumes/Keywest_JetDrive 1/데이터저장소/skorea-municipalities-2018-geo.json"),
)
